...
<html lang="en">
<head>
    <title>MyDailyMD - Patient Prescription History</title>
    <meta charset="UTF-8">
...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        <h1><b>Prescription History</b></h1>
        <p><i>Sent by Medical Professionals</i></p>
        <div class="row">
            <div class="content">
                        ...
                        <div class="container">
                            <table class="table">
                                ...
                                <tr style="background-color:whitesmoke">
                                    <td>Dr. {{ Crypt::decryptString($pres->name) }}</td>
                                    <td>{{ date('F j, Y', strtotime($pres->date)) }}</td>
                ...
                <a href="{{ route('patientmedication.index') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
</div>
