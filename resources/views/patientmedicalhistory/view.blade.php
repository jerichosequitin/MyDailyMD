...
<html lang="en">
<head>
    <title>MyDailyMD - View Medical History</title>
    <meta charset="UTF-8">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <form>
                    ...
                    <center>
                        <div class="user-details">
                            <div class="input-box">
                                ...
                                <input type="text" value="{{$medicalHistory->surgicalProcedure }}" class="form-control" name="surgicalProcedure" disabled>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" value="{{ date('F j, Y', strtotime($medicalHistory->surgeryDate)) }}" class="form-control" name="surgeryDate" disabled>
                            </div>
                            <div class="input-box">
                                <span class="details">Surgery Notes</span>
                                <input type="text" value="{{$medicalHistory->surgeryNotes }}" class="form-control" name="surgeryNotes" disabled>
                            </div>
                        </div>
                    </center>
                </div>
                ...
                <br>
                <a href="{{ url('patientmedicalhistory/') }}" class="btn btn-primary">Back</a>
                <a href="#edit{{$medicalHistory->id}}" data-bs-toggle="modal" class="btn btn-danger"> Delete</a>
                @include('patientmedicalhistory.archived')
        </div>
    </div>
</div>
</body>
