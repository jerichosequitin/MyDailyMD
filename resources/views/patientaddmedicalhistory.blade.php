...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        ...
        <div class="content">
            <form action="patientaddmedicalhistory">
                <div class="container">
                    <center>
                        <div class="user-details">
                            <div class="input-box">
                                <span class="details">Surgical Procedure</span>
                                <input type="text" class="form-control"name="surgeryProcedure">
                            </div>
                            <div class="input-box">
                                <span class="details">Hospital</span>
                                <input type="text" class="form-control"name="surgeryHospital">
                            </div>
                            <div class="input-box">
                                <span class="details">Surgery Date</span>
                                <input type="date" class="form-control"name="surgeryDate">
                            </div>
                            <div class="input-box">
                                <span class="details">Surgery Notes</span>
                                <textarea id="surgeryNotes" name="surgeryNotes"style="height:150px"></textarea>
                            </div>
                        </div>
