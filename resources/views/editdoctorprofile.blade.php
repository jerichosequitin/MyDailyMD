                ...
                <div class="container">
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" value="{{ date('F j, Y', strtotime(Auth::user()->doctor_profile->birthdate)) }}" class="form-control" name="birthdate" disabled>
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" class="form-control" value="{{$user->doctor_profile->contactNumber }}" style="width: 60%; float: right" name="contactNumber" id="contactNumber" required>
                        </div>
                        <div class="input-box">
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" value="{{$user->doctor_profile->clinicMobileNumber }}"
                                   ...
                                   maxlength = "10"
                                   title="Format: 9XXXXXXXXX" class="form-control" name="clinicMobileNumber" required>
                        </div>
                        <div class="input-box">
                            <span class="details">Clinic Telephone Number</span>
                            <input type="text" value="{{$user->doctor_profile->clinicLandlineNumber }}"
                                   maxlength = "8"
