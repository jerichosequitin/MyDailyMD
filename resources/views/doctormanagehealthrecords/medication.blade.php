    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                        ...
                        <div class="container">
                            <table class="table">
                                ...
                                <tr style="background-color:whitesmoke">
                                    ...
                                    <td><a href="{{ route('managehealthrecords.medication_view', $med->id) }}" class="btn btn-info btn-sm">View</a></td>
                                    <td><a href="{{ route('managehealthrecords.medication_edit', $med->id) }}" class="btn btn-success btn-sm">Edit</a></td>
                                </tr>
                                @endforeach
                                </thead>
                            </table>
                ...
                <a href="{{ route('managehealthrecords.medication_create', $patientProfile->id) }}" class="btn btn-primary">Add</a>
            </div>
        </div>
    </div>
</div>
