    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                ...
                @endif
                <div class="column">
                    <form method="post" action="{{ route('managehealthrecords.progressnote_store') }}">
                        @csrf
                        <div class="container">
                            <div class="user-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" class="form-control" name="primaryDiagnosis" required>
                                </div>
                                <div class="input-box">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" class="form-control" name="treatmentPlan" required>
                                </div>
                                <div class="input-box">
