    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                    ...
                    <div class="column">
                        ...
                        <div class="container">
                            <table class="table">
                                ...
                                @foreach($progressNote as $pn)
                                <tr style="background-color:whitesmoke">
                                    <td>{{ date('F j, Y', strtotime($pn->created_at)) }}</td>
                                    <td>{{ $pn->primaryDiagnosis }}</td>
                                    <td>{{ $pn->findings }}</td>
                                    <td>{{ $pn->treatmentPlan }}</td>
                                    <td>Dr. <b>{{ $pn->createdBy }}</b></td>
                                    <td><a href="{{ route('managehealthrecords.progressnote_view', $pn->id) }}" class="btn btn-info btn-sm">View</a></td>
                                    <td><a href="{{ route('managehealthrecords.progressnote_edit', $pn->id) }}" class="btn btn-success btn-sm">Edit</a></td>
                                </tr>
                                @endforeach
                                </thead>
                            </table>
                ...
                <a href="{{ route('managehealthrecords.progressnote_create', $patientProfile->id) }}" class="btn btn-primary">Add</a>
            </div>
        </div>
    </div>
</div>
