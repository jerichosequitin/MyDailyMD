...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                    <div class="column">
                        <form method="post" action="{{ route('managehealthrecords.allergy_update', $allergy->id) }}">
                            @csrf
                            @method('PATCH')
                        <div class="container">
                            <div class="user-details">
                                <div class="input-box">
                                    ...
                                    <select name="type" class="form-control" required>
                                        <option value="{{$allergy->type}}" selected hidden>{{$allergy->type}} Allergy</option>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" class="form-control" name="trigger" value="{{$allergy->trigger}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Reaction</span>
                                    <input type="text" class="form-control" name="reaction" value="{{$allergy->reaction}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Treatment</span>
                                    <input type="text" class="form-control" name="treatment" value="{{$allergy->treatment}}" required>
                                </div>
                                <div class="input-box">
