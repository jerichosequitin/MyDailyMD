...
<html lang="en">
<head>
    <title>MyDailyMD - Patient Progress Note</title>
    <meta charset="UTF-8">
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                ...
                @endif
                    <div class="column">
                        <form method="post" action="{{ route('managehealthrecords.progressnote_update', $progressNote->id) }}">
                            @csrf
                            @method('PATCH')
                        <div class="container">
                            <div class="user-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" class="form-control" name="primaryDiagnosis" value="{{$progressNote->primaryDiagnosis}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Findings</span>
                                    <input type="text" class="form-control" name="findings" value="{{$progressNote->findings}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Treatment Plan</span>
                                    <input type="text" class="form-control" name="treatmentPlan" value="{{$progressNote->treatmentPlan}}" required>
                                </div>
                                <div class="input-box">
