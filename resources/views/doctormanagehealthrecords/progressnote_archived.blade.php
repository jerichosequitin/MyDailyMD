<!-- Accepted Modal -->
<div class="modal fade" id="edit{{$progressNote->id}}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #DEF1FD">
            ...
            <div class="modal-body">
                <form action="{{ route('managehealthrecords.progressnote_archive', $progressNote->id)}}" method="post" style="display: inline-block">
                    @csrf
                    @method('PATCH')
                        <center>
