...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="content">
                    <div class="column">
                        <form method="post" action="{{ route('managehealthrecords.medication_update', $medication->id) }}">
                            @csrf
                            @method('PATCH')
                        <div class="container">
                            <div class="user-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" class="form-control" name="frequency" value="{{$medication->frequency}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Physician</span>
                                    <input type="text" class="form-control" name="physician" value="{{$medication->physician}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Start Date</span>
                                    <input type="date" class="form-control" name="startDate" value="{{$medication->startDate}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">End Date</span>
                                    <input type="date" class="form-control" name="endDate" value="{{$medication->endDate}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Purpose</span>
                                    <input type="text" class="form-control" name="purpose" value="{{$medication->purpose}}" required>
                                </div>
                                <div class="input-box">
                                    <span class="details">Modified By</span>
                                    <input type="text" value="{{Auth::user()->id }}" class="form-control" name="modifiedBy_user_id" required readonly hidden>
                                    <input type="text" value="{{Auth::user()->name }}" class="form-control" name="modifiedBy" required readonly>
                                </div>
                            </div>
                        </div>
                <br>
