...
<html lang="en">
<head>
    <title>MyDailyMD - Add Allergies (Doctor)</title>
    <meta charset="UTF-8">
...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        <h1>
            <b>Add Allergy Record</b>
        </h1>
        <div class="content">
            <form action="doctoraddallergies">
                <div class="container">
                    <center>
                        <div class="user-details">
                            <select id="allergies" required>
                                <option value="" selected disabled hidden>Allergy Type</option>
                            ...
                            <div class="input-box">
                                <input type="text" class="form-control"name="allergyTrigger" placeholder="Trigger">
                            </div>
                            <div class="input-box">
                                <input type="text" class="form-control"name="allergyReaction" placeholder="Reaction">
                            </div>
                            <div class="input-box">
                                <input type="text" class="form-control"name="allergyTreatment" placeholder="Treatment">
                            </div>
                        </div>
