...
<html lang="en">
<head>
    <title>MyDailyMD - Update License</title>
    <meta charset="UTF-8">
...
<div class="container-fluid p-5 text-black text-center">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            @endif
            <form method="post" action="/doctorprofile/{{ $user->id }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="container">
                    <center>
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" value="{{ $user->doctor_profile->prcNumber }}"
                                       maxlength = "7"
                                       title="Format: XXXXXXX" class="form-control" placeholder="XXXXXXX" name="prcNumber" disabled>
                            </div>
                            <div class="input-box">
