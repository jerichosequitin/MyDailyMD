...
class DoctorAppointmentReminder
{
    /**
    ...
    private function _remindAbout($appointment)
    {
        ...
        $message = "Hello $doctorName, this is a reminder that you have an appointment with $patientName today at $time!";
        $this->_sendMessage('+63'.$doctorInfo->contactNumber, $message);
